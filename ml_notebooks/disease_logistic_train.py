...
print("naive bayes for disease prediction")
import pandas as pd
import numpy as np
...
print("Train score   :",logistic.score(X,y)*100)
print("Test score   :",logistic.score(X,y)*100)

y_pred = logistic.predict(X_test)
print("accuracy of logistic regression model on the test set:")
